<div id="affwp-affiliate-dashboard-referral-counts" class="affwp-tab-content p20 bg-white">
...
<div id="affwp-affiliate-dashboard-earnings-stats" class="affwp-tab-content p20 pt0 bg-white">
	<table class="affwp-table">
		<thead>
			<tr>
