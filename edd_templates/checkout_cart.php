...
<table id="edd_checkout_cart" <?php if ( ! edd_is_ajax_disabled() ) { echo 'class="ajaxed"'; } ?>>
	<thead>
		<tr class="edd_cart_header_row">
			...
			<th class="edd_cart_item_name"><?php _e( 'Product', 'edd' ); ?></th>
			<th class="edd_cart_item_price"><?php _e( 'Price', 'edd' ); ?></th>
				...
				<tr class="edd_cart_item" id="edd_cart_item_<?php echo esc_attr( $key ) . '_' . esc_attr( $item['id'] ); ?>" data-download-id="<?php echo esc_attr( $item['id'] ); ?>">
					...
					<td class="edd_cart_item_name">
						<?php
							...
							echo '<span class="edd_checkout_cart_item_title"><span>' . esc_html( $item_title ) . '</span></span>';
						?>
					</td>
...
<!--
<section id="product-faq" class="pb bg-white">
    <div class="">
        <div class="row">
            ...
            <div class="col-xs-7">
                <h2 class="mt40 mb10">30 Day Money-Back Guarantee</h2>
                <div class="">
                    <div>
