...
if ( is_user_logged_in() ):
	...
	<form id="edd_profile_editor_form" class="edd_form" action="<?php echo edd_get_current_page_url(); ?>" method="post">
		<fieldset>
			<span id="edd_profile_name_label"><legend><?php _e( '', 'edd' ); ?></legend></span>
			...
			<span id="edd_profile_billing_address_label"><legend><?php _e( '', 'edd' ); ?></legend></span>
			...
			<span id="edd_profile_password_label"><legend><?php _e( '', 'edd' ); ?></legend></span>
