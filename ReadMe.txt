# Tutorials & support
	- codex.gabfire.com
	- forums.gabfire.com (members only forums)

For installation guide http://codex.gabfire.com/
Scroll page down for Changelog
...
Additionally, you can post a thread in the Showcase section on the Forums with your site info for the rest of the
...
- Bootstrap HTML, CSS, and JS Framework (framework/bootstrap)
	Website 	: http://http://getbootstrap.com/
	License 	: MIT
...
- Modernizr (inc/js/modernizr.custom.js)
	Website		: http://modernizr.com/
	License		: MIT
	
- TinyNav	(inc/js/responsive-menu.js)
	Website		: http://tinynav.viljamis.com v1.1
	License		: MIT License
	
- jQuery Selectbox	(inc/js/responsive-menu.js)
	Website		: http://www.bulgaria-web-developers.com/projects/javascript/selectbox/
	License		: MIT License
	
- WOW (inc/js/wow.min.js)
	Website		: https://github.com/matthieua/WOW
	License		: MIT License
	
- Shuffle (inc/js/query.shuffle.min.js)
	Website		: http://vestride.github.io/Shuffle/
	License		: MIT License
	
- Shuffle Debounce Plugin (inc/js/query.shuffle.min.js)
	Website		: http://benalman.com/projects/jquery-throttle-debounce-plugin/
	License		: MIT License
	
- Colorbox (inc/js/jquery.colorbox-min.js)
	Website		: http://www.jacklmoore.com/colorbox/
	License		: MIT License
	
- OWL Carousel (inc/js/owl.carousel.min.js)
	Website		: http://owlgraphic.com/owlcarousel/
	License		: MIT License
	
- Stellar (inc/js/stellar.js)
	Website		: https://github.com/markdalgleish/stellar.js
	License		: MIT License

			
-> Z 0.2
------------------------------------------
	- Google Structured Data and Schema Org implementation
		-- loop-2col.php
		-- loop-3col.php
		-- loop-4col.php
		-- loop-default.php
	...
	- Add an extra option to use regular blog layout for Team Member Entries
		-- options.php
		-- single-member.php
		-- loop-single.php
	- Display portfolio entries without their ID numbes entered into theme control panel
		-- index.php
	- Add background change option for footer contact section
		-- framework/functions/gabfire-media.php
		-- options.php
		-- css/customizedcss.php
		-- images directory
		-- style.css
