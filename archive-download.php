	...
	<div id="store-front" class="container">
		...
		<div class="row product-grid clear">
    		...
    		<div class="col-md-12 col-sm-12 featured-product">
				<div class="p30 rd-5">
					<div class="product-description">
						<h2 class="mt20 mb text-center">Our Newest WordPress Plugin</h2>
						<div class="col-md-6 pt30">
    						<p><a href="https://99robots.com/products/optin-fire/">Optin Fire</a> is an all-in-one solution for adding popups, banners, flyouts, in-post content, and widget CTAs to your web pages. </p>
    						<p>Choose from 9 types of CTA, integrate with major newsletter providers, and display opt-ins with a variety of powerful triggers.</p>
    						<a href="https://99robots.com/products/optin-fire/" class="btn btn-space btn-orange">Learn More about Optin Fire</a>
						</div>
						<div class="col-md-6 text-center">
                            <a href="https://99robots.com/products/optin-fire/"><img src="http://99robots.com/wp-content/uploads/2015/09/Screen-Shot-2015-09-01-at-3.44.22-PM-e1441139614912.png" /></a>
						</div>
					</div>
				</div>
            </div>
    		...
    		<div class="col-md-12 col-sm-12 featured-product">
				<div class="p30 rd-5">
					<div class="product-description">
						...
						<div class="col-md-6 text-center">
                            <a href="https://99robots.com/products/wp-background-takeover-advertisements/"><img src="https://99robots.com/wp-content/uploads/edd/2015/06/envato-banner-590x300-2.jpg" /></a>
						</div>
						<div class="col-md-6 pt30">
    						<p><a href="https://99robots.com/products/wp-background-takeover-advertisements/">WP Background Takeover Advertisements</a> makes it easy to add wallpaper advertisements on your site. </p>
    						<p>Set different advertisements for individual posts, pages, categories, or by any custom taxonomy and take full control of your website.</p>
    						<a href="https://99robots.com/products/wp-background-takeover-advertisements/" class="btn btn-space btn-orange pull-right">Learn More about Background Takeover</a>
						</div>
					</div>
				</div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 bt-ltgray mt">
				<div class="p30 rd-5">
					<div class="product-description">
						<h2 class="mt20 mb0 text-center">All 18 Awesome WordPress Plugins</h2>
					</div>
				</div>
            </div>

            <?php
            $fire_suite_ids = array('7412','4602','4601','4600','4591',);
            $fire_suite = array( 'ids' => $fire_suite_ids, 'name' => 'Conversion Plugins', 'desc' => 'Direct visitors to important pages on your site and capture leads with custom optins.', 'color' => 'orange',  );

            $post_suite_ids = array('4895','7081','7080',);
            $post_suite = array( 'ids' => $post_suite_ids, 'name' => 'Engagement Plugins', 'desc' => 'Keep visitors on your site by providing a variety of content at their fingertips.', 'color' => 'blue',  );

            $other_ids = array('4603','4604','7633','7145', '8384', '8383', '8333', '8382', '8378');
            ...
            $suites = array_merge($fire_suite_ids, $post_suite_ids, $other_ids, $free_ids);
