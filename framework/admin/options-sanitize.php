...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'gabfire' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'gabfire' ),
		'repeat-y'  => __( 'Repeat Vertically', 'gabfire' ),
		'repeat'    => __( 'Repeat All', 'gabfire' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'gabfire' ),
		'top center'    => __( 'Top Center', 'gabfire' ),
		'top right'     => __( 'Top Right', 'gabfire' ),
		'center left'   => __( 'Middle Left', 'gabfire' ),
		'center center' => __( 'Middle Center', 'gabfire' ),
		'center right'  => __( 'Middle Right', 'gabfire' ),
		'bottom left'   => __( 'Bottom Left', 'gabfire' ),
		'bottom center' => __( 'Bottom Center', 'gabfire' ),
		'bottom right'  => __( 'Bottom Right', 'gabfire')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'gabfire' ),
		'fixed'  => __( 'Fixed in Place', 'gabfire')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'gabfire' ),
		'italic'      => __( 'Italic', 'gabfire' ),
		'bold'        => __( 'Bold', 'gabfire' ),
		'bold italic' => __( 'Bold Italic', 'gabfire' )
	);
