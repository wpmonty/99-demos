...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Theme Options', 'gabfire'),
		'menu_title' => __('Theme Options', 'gabfire'),
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear', 'gabfire' ),
			'defaultString' => __( 'Default', 'gabfire' ),
			'pick' => __( 'Select Color', 'gabfire' )
		);
...
function gab_adminheader() { ?>
	<div id="panelheader">
		<div id="branding">
			<a href="http://www.gabfirethemes.com/" />
				<img src="<?php echo get_template_directory_uri(); ?>/framework/admin/images/logo.png" alt="" />
			</a>
		</div>
		<div class="header-info">
			<?php
				$themename = wp_get_theme();
				$t_name = $themename->{'Name'};
				$t_version = $themename->{'Version'};
				$t_name = str_replace("-", " ", $t_name);
				echo ucwords($t_name) . '&nbsp;' . $t_version;
			?>
		</div>
	</div>
	...
	<div id="gablinkbar">
		<ul>
			<li><a class="gab-site" href="http://www.gabfirethemes.com/" target="_blank" />Gabfire Themes</a></li>
			<li><a class="gab-docs" href="http://www.gabfirethemes.com/codex" target="_blank" />Docs &amp; Tutorials</a></li>
			<li><a class="gab-support" href="http://forums.gabfire.com" target="_blank" />Support Forum</a></li>
			<li><a class="gab-blog last" href="http://www.gabfirethemes.com/blog/" target="_blank" />Latest News</a></li>
		</ul>
	</div>
    ...
    <div id="optionsframework-metabox">
	    ...
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'gabfire' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'gabfire' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'gabfire' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'gabfire' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'gabfire' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options', 'gabfire' ),
...
function of_sanitize_textarea_custom($input) {
    global $allowedposttags;
		...
		$of_custom_allowedtags["div"] = array(
		"style" => array(),
		"class" => array(),
		"id" => array(),
		"height" => array(),
        ...
        $of_custom_allowedtags["ins"] = array(
		"style" => array(),
        ...
        $of_custom_allowedtags = array_merge_recursive($of_custom_allowedtags, $allowedposttags);
...
function google_analytics(){
	$output = of_get_option('of_google_analytics');
	if ( $output <> "" ) 
...
/* Custom CSS */
	...
	add_action('wp_head', 'dnomia_head_css');